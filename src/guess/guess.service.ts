...
export class GuessService {
    ...
    async addGuess(body: CreateGuessDto) {
        ...
        if (existingGuess == undefined) {
            this.logger.debug("Adding guess with: playerID: " + body.user + ",  gameID: " + body.game + ", result: " + body.team1 + " - " + body.team2 + ", " + body.bet);
            ...
            this.logger.debug("Updating guess with: playerID: " + body.user + ",  gameID: " + body.game + ", result: " + body.team1 + " - " + body.team2 + ", " + body.bet);
